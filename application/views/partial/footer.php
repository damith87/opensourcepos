...
<div class="container padding10 bg-dark">
    <div class="text fg-white"> <?php echo $this->lang->line('common_you_are_using_ospos'); ?> <?php echo $this->config->item('application_version'); ?>.
